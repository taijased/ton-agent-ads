...
import { PrismaConversationMessageRepository } from "../infrastructure/prisma-conversation-message-repository.js";
import { PrismaConversationThreadRepository } from "../infrastructure/prisma-conversation-thread-repository.js";
...
export const createPrismaRepositories = (): RepositoryBundle => ({
  ...
  conversationThreadRepository: new PrismaConversationThreadRepository(),
  conversationMessageRepository: new PrismaConversationMessageRepository(),
