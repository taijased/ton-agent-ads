...
.claude/        → Repository workflow policy, defaults, and reusable skills
```

## Agent Delegation (Claude Code Mob Team)

NEVER implement backend or frontend code directly. Always delegate:

| Task | Agent |
|------|-------|
| NestJS services, Prisma, domain, repos | `agent_ts_backend` |
| React/Next.js components, hooks | `agent_frontend` |
| Tests (unit, integration, E2E) | `agent_tester` |
| Full feature end-to-end | `lead` |
