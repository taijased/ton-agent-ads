...
- Make workspace quality gates real and executable instead of documented-only requirements (`.codex/commands/implement_backend.md:48`, `workflows/feature_backend.md:75`, `package.json:6`).
...
- Contract check: env names, package scripts, and docs become consistent with the repository contracts already declared in `AGENTS.md:28`, `.codex/commands/implement_backend.md:48`, and `workflows/feature_backend.md:75`.
